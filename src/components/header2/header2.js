            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-2 col-md-6 col-6">
                <div className="navbar-header">
                  <Link className="navbar-brand logo" to='/'><small>Juan&Beatriz</small></Link>
                </div>
              </div>
              ...
              <div className="col-lg-2 col-md-2 col-2">
                <div className="header-right">
                  <Link className="theme-btn" to="/rsvp"><span className="text">Confirmar asistencia</span> <span className="mobile">
